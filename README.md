...
Реализовано:
 - Каталог продуктов
 - Страницы:главная,карточка товара,избраное,профиль,добавления/удаления товара ...
 - Сделана визуализация популярности товаров посредством графика(библиотека Ant)
